...
const Advice = () => {
    ...
    return (
        <div className='h-auto w-[600px] rounded-lg bg-Dark-Grayish-Blue flex flex-col justify-center items-center '>
            <h1 className=' text-Neon-Green font-Manrope text-[15px] my-8'>ADVICE #{loading ? <>..loading</> : <>{gettingAdvice.id}</>}</h1>
            ...
            <a className=' mt-8 w-[65] h-[65px] flex items-center justify-center ' onClick={getAdvice} >
